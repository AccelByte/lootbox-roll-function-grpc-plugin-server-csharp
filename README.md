# lootbox-roll-function-grpc-plugin-server-csharp
...
This repository contains a `sample lootbox roll function gRPC server app` written in `C#`. It provides a simple custom lootbox roll function for platform service in `AccelByte Gaming Services`.
...
7. Refer to [Demo CLI](src/AccelByte.PluginArch.LootBox.Demo.Client/README.md) readme on how to use the demo cli app to test the service.
