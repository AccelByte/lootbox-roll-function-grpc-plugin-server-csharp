...
namespace AccelByte.PluginArch.LootBox.Demo.Server
{
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            if (appServiceName == null)
                appServiceName = "extend-app-lootbox-roll";
            else
                appServiceName = $"extend-app-lr-{appServiceName.Trim().ToLower()}";
            ...
            if (appResourceName == null)
                appResourceName = "LOOTBOXROLLEXTENDAPP";
